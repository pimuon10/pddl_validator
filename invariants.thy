...
(BigAnd [formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?y''))), formula.Atom (predAtm (Pred (''idle''))([])), formula.Atom (predAtm (Pred (''cw''))([Var ''?x'',Var ''?y'']))])
...
definition "continue_cut = Action_Schema(''continue-cut'')
 [(Var ''?x'',Either([''object''])), (Var ''?y'',Either([''object'']))]
(BigAnd [formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?y''))), formula.Atom (predAtm (Pred (''cutting''))([])), formula.Atom (predAtm (Pred (''s-last''))([Var ''?x''])), formula.Atom (predAtm (Pred (''cw''))([Var ''?x'',Var ''?y'']))])
...
(BigAnd [formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?y''))), formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?z''))), formula.Atom (predAtm (Pred (''cutting''))([])), formula.Atom (predAtm (Pred (''s-last''))([Var ''?x''])), formula.Atom (predAtm (Pred (''cw''))([Var ''?x'',Var ''?y''])), formula.Atom (predAtm (Pred (''cut-point-1''))([Var ''?z'']))])
...
definition "begin_transpose_splice = Action_Schema(''begin-transpose-splice'')
 [(Var ''?x'',Either([''object''])), (Var ''?y'',Either([''object'']))]
(BigAnd [formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?y''))), formula.Atom (predAtm (Pred (''have-cut''))([])), formula.Atom (predAtm (Pred (''cw''))([Var ''?x'',Var ''?y'']))])
...
definition "continue_splice = Action_Schema(''continue-splice'')
 [(Var ''?x'',Either([''object''])), (Var ''?y'',Either([''object''])), (Var ''?z'',Either([''object'']))]
(BigAnd [formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?y''))), formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?z''))), formula.Not (formula.Atom (atom.Eq (Var ''?z'') (Var ''?y''))), formula.Atom (predAtm (Pred (''splicing''))([])), formula.Atom (predAtm (Pred (''s-first''))([Var ''?x''])), formula.Atom (predAtm (Pred (''s-next''))([Var ''?x'',Var ''?y''])), formula.Atom (predAtm (Pred (''splice-point-1''))([Var ''?z'']))])
...
definition "end_splice = Action_Schema(''end-splice'')
 [(Var ''?x'',Either([''object''])), (Var ''?y'',Either([''object''])), (Var ''?z'',Either([''object'']))]
(BigAnd [formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?y''))), formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?z''))), formula.Not (formula.Atom (atom.Eq (Var ''?z'') (Var ''?y''))), formula.Atom (predAtm (Pred (''splicing''))([])), formula.Atom (predAtm (Pred (''s-first''))([Var ''?x''])), formula.Atom (predAtm (Pred (''s-last''))([Var ''?x''])), formula.Atom (predAtm (Pred (''splice-point-1''))([Var ''?y''])), formula.Atom (predAtm (Pred (''splice-point-2''))([Var ''?z'']))])
...
definition "begin_inverse_splice = Action_Schema(''begin-inverse-splice'')
 [(Var ''?x'',Either([''object''])), (Var ''?y'',Either([''object'']))]
(BigAnd [formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?y''))), formula.Atom (predAtm (Pred (''have-cut''))([])), formula.Atom (predAtm (Pred (''cw''))([Var ''?x'',Var ''?y''])), formula.Atom (predAtm (Pred (''last-cut-point''))([Var ''?x'']))])
(Effect [formula.Atom (predAtm (Pred (''inverse-splicing''))([])), formula.Atom (predAtm (Pred (''splice-point-1''))([Var ''?x''])), formula.Atom (predAtm (Pred (''splice-point-2''))([Var ''?y'']))][formula.Atom (predAtm (Pred (''have-cut''))([])), formula.Atom (predAtm (Pred (''cw''))([Var ''?x'',Var ''?y'']))])"
...
definition "continue_inverse_splice_a = Action_Schema(''continue-inverse-splice-a'')
 [(Var ''?x'',Either([''object''])), (Var ''?y'',Either([''object''])), (Var ''?z'',Either([''object'']))]
(BigAnd [formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?y''))), formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?z''))), formula.Not (formula.Atom (atom.Eq (Var ''?z'') (Var ''?y''))), formula.Atom (predAtm (Pred (''inverse-splicing''))([])), formula.Atom (predAtm (Pred (''splice-point-1''))([Var ''?z''])), formula.Atom (predAtm (Pred (''normal''))([Var ''?x''])), formula.Atom (predAtm (Pred (''s-last''))([Var ''?x''])), formula.Atom (predAtm (Pred (''s-next''))([Var ''?y'',Var ''?x'']))])
...
definition "continue_inverse_splice_b = Action_Schema(''continue-inverse-splice-b'')
 [(Var ''?x'',Either([''object''])), (Var ''?y'',Either([''object''])), (Var ''?z'',Either([''object'']))]
(BigAnd [formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?y''))), formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?z''))), formula.Not (formula.Atom (atom.Eq (Var ''?z'') (Var ''?y''))), formula.Atom (predAtm (Pred (''inverse-splicing''))([])), formula.Atom (predAtm (Pred (''splice-point-1''))([Var ''?z''])), formula.Atom (predAtm (Pred (''inverted''))([Var ''?x''])), formula.Atom (predAtm (Pred (''s-last''))([Var ''?x''])), formula.Atom (predAtm (Pred (''s-next''))([Var ''?y'',Var ''?x'']))])
...
definition "end_inverse_splice_a = Action_Schema(''end-inverse-splice-a'')
 [(Var ''?x'',Either([''object''])), (Var ''?y'',Either([''object''])), (Var ''?z'',Either([''object'']))]
(BigAnd [formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?y''))), formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?z''))), formula.Atom (predAtm (Pred (''inverse-splicing''))([])), formula.Atom (predAtm (Pred (''normal''))([Var ''?x''])), formula.Atom (predAtm (Pred (''splice-point-1''))([Var ''?y''])), formula.Atom (predAtm (Pred (''splice-point-2''))([Var ''?z''])), formula.Atom (predAtm (Pred (''s-first''))([Var ''?x''])), formula.Atom (predAtm (Pred (''s-last''))([Var ''?x'']))])
...
definition "end_inverse_splice_b = Action_Schema(''end-inverse-splice-b'')
 [(Var ''?x'',Either([''object''])), (Var ''?y'',Either([''object''])), (Var ''?z'',Either([''object'']))]
(BigAnd [formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?y''))), formula.Not (formula.Atom (atom.Eq (Var ''?x'') (Var ''?z''))), formula.Atom (predAtm (Pred (''inverse-splicing''))([])), formula.Atom (predAtm (Pred (''inverted''))([Var ''?x''])), formula.Atom (predAtm (Pred (''splice-point-1''))([Var ''?y''])), formula.Atom (predAtm (Pred (''splice-point-2''))([Var ''?z''])), formula.Atom (predAtm (Pred (''s-first''))([Var ''?x''])), formula.Atom (predAtm (Pred (''s-last''))([Var ''?x'']))])
...
assumes "list_all2 (ast_problem.is_obj_of_type PI) args (map snd (parameters  begin_cut))"
  ...
  unfolding ast_problem.invariant_act_def ast_problem.execute_ast_action_inst_def
proof(safe)
  ...
  show "x_inverted(ast_domain.apply_effect (ast_action_inst.effect (ast_domain.instantiate_action_schema  begin_cut args)) s)"
    ...
    apply(auto simp add: args_2)
        by (auto simp add: ast_domain.instantiate_action_schema.simps ast_domain.apply_effect.simps ast_problem.ast_action_inst_enabled_def entailment_def ast_problem.holds_def ast_problem.valuation_def)
qed
...
x_inverted_invariant_begin_cut x_inverted_invariant_continue_cut x_inverted_invariant_end_cut x_inverted_invariant_begin_transpose_splice x_inverted_invariant_continue_splice x_inverted_invariant_end_splice x_inverted_invariant_begin_transverse_splice x_inverted_invariant_begin_inverse_splice x_inverted_invariant_begin_inverse_splice_special_case x_inverted_invariant_continue_inverse_splice_a x_inverted_invariant_continue_inverse_splice_b x_inverted_invariant_end_inverse_splice_a x_inverted_invariant_end_inverse_splice_b x_inverted_invariant_reset_1
    unfolding prob_dom_def dom_actions_def
begin_cut_def continue_cut_def end_cut_def begin_transpose_splice_def continue_splice_def end_splice_def begin_transverse_splice_def begin_inverse_splice_def begin_inverse_splice_special_case_def continue_inverse_splice_a_def continue_inverse_splice_b_def end_inverse_splice_a_def end_inverse_splice_b_def reset_1_def
  by auto
